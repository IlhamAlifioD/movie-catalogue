...
describe("Searching movies", () => {
	...
	describe("When query is not empty", () => {
		...
		// ? memeriksa judul film ditampilkan
		it("should show the name of the movies found by Favorite Movies", (done) => {
			document
				.getElementById("movies")
				.addEventListener("movies:updated", () => {
					const movieTitles =
						document.querySelectorAll(".movie__title");
	...
	describe("When no favorite movies could be found", () => {
		...
		it("should show the empty message", (done) => {
			...
			// ? Meminta searchMovies mengembalikan array kosong.
			favoriteMovies.searchMovies.mockImplementation((query) => []);

			searchMovies("film a");
		});

		// ? Memastikan tidak ada satupun film yang ditampilkan
